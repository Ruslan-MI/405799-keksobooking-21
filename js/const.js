...
(() => {
  ...
  window.const = {
    PIN_WIDTH, PIN_HEIGHT, MAIN_PIN_WIDTH, MAIN_PIN_HEIGHT, MAIN_PIN_SPIKE_HEIGHT, STATUS_CODE, TIMEOUT_IN_MS, URL_DOWNLOAD, MIN_X_COORDS, MIN_Y_COORDS, MAX_Y_COORDS
  };
})();
